...
*Defined in [defaults.ts:6](https://github.com/polkadot-js/common/blob/90ca8a0d/packages/keyring/src/defaults.ts#L6)*
...
*Defined in [defaults.ts:9](https://github.com/polkadot-js/common/blob/90ca8a0d/packages/keyring/src/defaults.ts#L9)*
